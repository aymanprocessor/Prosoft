...
namespace ProSoft.EF.Migrations
{
    ...
    [Migration("20240905131456_renameFields-UserSideTable-UsersGroupTable")]
    partial class renameFieldsUserSideTableUsersGroupTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.UserSide", b =>
                {
                    ...
                    b.Property<int>("RegionsRegionCode")
                        .HasColumnType("int");

                    b.Property<int>("SidesSideId")
                        .HasColumnType("int");

                    b.Property<int>("USER_G_ID")
                        .HasColumnType("int")
                        .HasColumnName("USER_G_ID");
                    ...
                    b.HasKey("USER_CODE", "SIDE_ID", "DEPT_ID", "BRANCH_ID");

                    b.HasIndex("BranchsBranchId");

                    b.HasIndex("EisSectionTypesSecCode");

                    b.HasIndex("RegionsRegionCode");

                    b.HasIndex("SidesSideId");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.UserSide", b =>
                {
                    ...
                    b.HasOne("ProSoft.EF.Models.Medical.HospitalPatData.Region", "Regions")
                        .WithMany()
                        .HasForeignKey("RegionsRegionCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProSoft.EF.Models.Stocks.Side", "Sides")
                        .WithMany()
                        .HasForeignKey("SidesSideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
