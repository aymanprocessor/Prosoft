...
namespace ProSoft.EF.Migrations
{
    ...
    [Migration("20241216144437_Create BedCode Table")]
    partial class CreateBedCodeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Medical.HospitalPatData.BedCode", b =>
                {
                    b.Property<int?>("Id")
                        .HasColumnType("int")
                        .HasColumnName("B_CODE");

                    b.Property<string>("BedCodeSys")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("B_CODE_SYS");

                    b.Property<int?>("BedOnOff")
                        .HasColumnType("int")
                        .HasColumnName("B_ON_OFF");
                    ...
                    b.Property<decimal?>("PatientPrice")
                        ...
                        .HasColumnName("PRICE_PAT");

                    b.Property<decimal?>("RelativetPrice")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("PRICE_RELATIVET");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Medical.HospitalPatData.DegreeCode", b =>
                {
                    b.Property<int?>("Id")
                        .HasColumnType("int")
                        .HasColumnName("D_CODE");
                    ...
                    b.Property<string>("DegreeName2")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("D_NAME2");

                    b.Property<int?>("DegreeOnOff")
                        .HasColumnType("int")
                        .HasColumnName("D_ON_OFF");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Medical.HospitalPatData.RoomCode", b =>
                {
                    b.Property<int?>("Id")
                        .HasColumnType("int")
                        .HasColumnName("R_CODE");
                    ...
                    b.Property<int?>("RoomOnOff")
                        .HasColumnType("int")
                        .HasColumnName("R_ON_OFF");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Price", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.ExpenseData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.ItemUnit", b =>
                {
                    b.Property<string>("ItemCode")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)")
                    ...
                    b.Property<bool>("DefaultUnit")
                        .HasColumnType("bit")
                        .HasColumnName("DEFULT_UNIT");

                    b.Property<decimal>("ItemQty")
                        .HasColumnType("decimal(6, 2)")
                        .HasColumnName("ITEM_QTY");

                    b.HasKey("ItemCode", "UnitCode", "Flag1", "BranchId");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.ItemsCustPrice", b =>
                {
                    b.Property<string>("ItemCode")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("ITEM_CODE");
                    ...
                    b.Property<float?>("BranchId")
                        .HasColumnType("real")
                        .HasColumnName("BRANCH_ID");

                    b.Property<float?>("CategoryPrice")
                        .HasColumnType("real")
                        .HasColumnName("CATEGORY_PRICE");

                    b.Property<decimal?>("DiscountRate")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("DISCOUNT_RATE");

                    b.Property<float?>("Flag1")
                        .HasColumnType("real")
                        .HasColumnName("FLAG1");
                    ...
                    b.Property<string>("ItemTax1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ITEM_TAX1");

                    b.Property<string>("ItemTax2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ITEM_TAX2");
                    ...
                    b.HasKey("ItemCode", "CustNo");

                    b.ToTable("ITEMS_CUST_PRICE", "dbo");
                });
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.StoredProcedure.ItemBalance", b =>
                {
                    b.Property<decimal>("itm_balance")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.UserSide", b =>
                {
                    ...
                    b.Property<int>("EisSectionTypeId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.ItemUnit", b =>
                {
                    b.HasOne("ProSoft.EF.Models.Stocks.SubItem", "SubItem")
                        .WithMany()
                    ...
                    b.HasOne("ProSoft.EF.Models.Stocks.UnitCode", "UnitCodee")
                        .WithMany()
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.Stkbalance", b =>
                {
                    ...
                    b.HasOne("ProSoft.EF.Models.Stocks.MainItem", "MainItem")
                        .WithMany()
                        .HasForeignKey("MainCode")
                        .HasPrincipalKey("MainCode");
            ...
            modelBuilder.Entity("ProSoft.EF.Models.Stocks.UserSide", b =>
                {
                    ...
                    b.HasOne("ProSoft.EF.Models.Medical.HospitalPatData.EisSectionType", "EisSectionTypes")
                        .WithMany()
                        .HasForeignKey("EisSectionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
